...
class Score(object):
    ...
    def add_score_point(self, x=None, y=None):
        ...
        write_file(self.score_file, line, flag="a")
...
class MultiScores(object):
    ...
    def add_score_point(self, name, x=None, y=None):
        assert name in self.scores, f"Score {name} not found. Please add it first."
        self.scores[name].add_score_point(y, x)
